...
const season_title = document.querySelectorAll('.season_wrap .teb_title a')
...
// 2. 컨버스 탭제목 클릭(active변경) -> 컨버스 보이기, 나이키 숨기기
...
// 3. 나이키 탭제목 클릭(active변경) -> 나이키 보이기, 컨버스 숨기기

// a변수를 클릭이벤트함수로 사용 시 a의 다른페이지 이동속성(href) 때문에 스크롤이 위로 올라가는 문제 해결법
//html해결법 - <a href="javascript:boid(0)"> 태그가 많으면 불편할 수 있음
