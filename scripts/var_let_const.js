...
a = b; // b = 2 -> a = b = 2 (b변수값을 a변수에 대입한다. (a변수의 기존값 제거))
b = c; // c = 3 -> b = c = 3 (c변수값을 b변수에 대입한다. (b변수의 기존값 제거))
...
console.log(`${product_name} ${product_quantity}개 가격은 ${product_price}원입니다.`);
//주문수량 3개, 총 결제금액은 161730원입니다.
product_quantity = '3';
console.log(`주문수량 ${product_quantity}개, 총 결제금액은 ${product_price*product_quantity}원입니다.`);
// product_quantity변수의 데이터 종류는 ?
console.log(`product_quantity변수의 데이터 종류는 ${typeof(product_quantity)}`);
// 2+2=2Number , '1'+'1'=11 String