...
// const pTag = document.querySelectorAll('#box p')
// /* for(let i=0; i<3; i++) {
//     console.log(pTag[i]); 
//     pTag[i].addEventListener('mouseover',function(){
//         pTag[i].style.color = 'red';
//     })
// } */

// //DOM특화 ES6 for~in, for~of
// /* for(let i in pTag) {
//     pTag[i].addEventListener('mouseover',function(){
//         pTag[i].style.color = 'red';
//     })
...
// const d_gnb = document.querySelector('nav .gnb'); //드래그선택
// console.log(d_gnb);

// const d_gnb_clone = d_gnb.cloneNode(true); //복사(ctrl+c)
// console.log(d_gnb_clone);

// const m_nav = document.querySelector('.m_nav'); //선택
// console.log(m_nav);

// m_nav.appendChild(d_gnb_clone); //붙여넣기ctrl+v

// const m_nav_li = document.querySelectorAll('.m_nav .gnb > li')
// const m_nav_lnb = document.querySelectorAll('.m_nav .lnb')

// for(let i of m_nav_lnb) i.style.display = 'none';

// for(let i of m_nav_li){
//     console.log(i);
//     i.addEventListener('click',function(){
//         for(let j of m_nav_lnb) j.style.display = 'none';
